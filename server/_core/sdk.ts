...
class SDKServer {
  ...
  async authenticateRequest(req: Request): Promise<AuthenticatedUser> {
    ...
    // Permissions are data-backed. Re-read after the lightweight sign-in update so
    // a newly provisioned or repaired owner role is reflected in the same request.
